...
**Fig. 2. <ins><a target="_blank" rel="noopener noreferrer" href="https://nbviewer.jupyter.org/github/daniel-furman/ensemble-climate-projections/blob/main/Comparing_MLs.ipynb">Soft Voting Geo-prediction</a></ins>**. Example of PyImpute spatial prediction with soft-voting, <img src="https://render.githubusercontent.com/render/math?math=class vote = \P (\overline{rf,et,lgbm})">, Xantusia interpolation to 1970-2000 climate. 
